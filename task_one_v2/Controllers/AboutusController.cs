...
namespace task_one_v2.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Aboutid,Title,Description,Yearsofexperience,Numberofchef,Image1,Image2,Image3,Image4")] Aboutu aboutu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Aboutid,Title,Description,Yearsofexperience,Numberofchef,Image1,Image2,Image3,Image4")] Aboutu aboutu)
        {
